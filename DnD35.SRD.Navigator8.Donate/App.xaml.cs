...
using DnD35.SRD.Navigator8.Resources;
...
namespace DnD35.SRD.Navigator8
{
    public partial class App : Application
    {
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            LicenseService.IsDonate = true; //CRITICAL.  BYPASSES LICENSE CHECK FOR DONATE VERSION
        ...
        {
            LicenseService.IsDonate = true; //CRITICAL.  BYPASSES LICENSE CHECK FOR DONATE VERSION
            LicenseService.RefreshLicenseCheckNeeded = true;
        }
        ...
        {
            IsolatedStorage.SavedExceptionData = e.ExceptionObject.Message + Environment.NewLine + Environment.NewLine +
